...
Please note that due to an issue with R8 and the Supplier API (which is used within the pooling classes), libGDX 1.13.5 is not recommended for Android. Users are advised to stay on version 1.13.1. 
{: .notice--warning}
